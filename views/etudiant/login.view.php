...
<body class="h-full">
    <!-- <div class="w-1/3  h-96 bg-gray-100 mt-32 mx-auto my-auto"> -->
        ...
        <div >
        <form method="POST" action="/login" class="block mx-auto p-5 space-y-4" >
                    
                    <div class="  w-full">
                            <input type="password" name="matricule" x-model="input2" class=" w-96 h-10 px-4 py-1 rounded-r-md border border-gray-100 text-gray-800 focus:outline-none"
